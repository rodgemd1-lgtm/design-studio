...
- Name: tests/dashboard.spec.ts >> site extraction cards show colors and techniques
- Location: tests/dashboard.spec.ts:61:5
...
Call log:
  - waiting for locator('text=Site Extractions')
...
- main [ref=e3]:
  - paragraph [ref=e4]:
    ...
    - generic [ref=e9]:
      - text: "ID:"
      - code [ref=e10]: "`cle1::7jzql-1778204969763-879bf4f182e5`"
