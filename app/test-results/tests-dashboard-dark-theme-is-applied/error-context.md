...
- Name: tests/dashboard.spec.ts >> dark theme is applied
- Location: tests/dashboard.spec.ts:54:5
...
- main [ref=e3]:
  - paragraph [ref=e4]:
    ...
    - generic [ref=e9]:
      - text: "ID:"
      - code [ref=e10]: "`cle1::cnwvk-1778204969198-c48f8db3e848`"
