...
- Name: tests/layout.spec.ts >> RIG Design Studio — Layout & Alignment >> techniques count visible
- Location: tests/layout.spec.ts:67:7
...
Locator: locator('text=Techniques')
Expected: visible
Error: strict mode violation: locator('text=Techniques') resolved to 3 elements:
    1) <span>Techniques</span> aka getByRole('navigation').getByText('Techniques')
    2) <div>Techniques</div> aka getByRole('main').getByText('Techniques', { exact: true })
    3) <h2>◐ Techniques (11)</h2> aka getByRole('heading', { name: '◐ Techniques (11)' })

Call log:
  - Expect "toBeVisible" with timeout 5000ms
  - waiting for locator('text=Techniques')
